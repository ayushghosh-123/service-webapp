      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            At IndustryBlog, we are committed to protecting your privacy and maintaining the confidentiality 
            of your personal information. This Privacy Policy describes how we collect, use, disclose, and 
            protect your information when you visit our website and use our services. By using our website, 
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 mt-8">
          ...
          <div className="space-y-2 text-gray-700">
            <p><strong>Email:</strong> privacy@industryblog.com</p>
            <p><strong>Phone:</strong> +1 (555) 123-4567</p>
            <p><strong>Address:</strong> 123 Privacy Lane, New York, NY 10001</p>
          </div>
        </div>
